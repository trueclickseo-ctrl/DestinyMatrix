// explainer injected
export const uiTranslations_ru: Record<string, string> = {
  'explainer.title': "Что такое карта Матрицы Души (Матрицы Судьбы)?",
  'explainer.body': "Матрица Души — также известная как Матрица Судьбы — это диаграмма, построенная исключительно на основе вашей даты рождения. Она отображает ваши ключевые числа, повторяющиеся жизненные паттерны и сферы, где эти паттерны проявляются сильнее всего.",
  "brand.tagline": "Картирование архитектуры вашей души",
  ...
  "hero.title": "Ваша бесплатная карта Матрицы Судьбы",
