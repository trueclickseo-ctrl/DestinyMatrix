// explainer injected
export const uiTranslations_ta: Record<string, string> = {
  ...
  "brand.tagline": "உங்கள் ஆத்மாவின் அமைப்பை வரைபடம் செய்தல்",
  ...
  "hero.title": "உங்கள் இலவச ஆத்மா மேட்ரிக்స్ வரைபடம்",
