// explainer injected
export const uiTranslations_gu: Record<string, string> = {
  ...
  "brand.tagline": "તમારા આત્માના સ્થાપત્યનું મેપિંગ",
  ...
  "hero.title": "તમારું મફત સોલ મેટ્રિક્સ ચાર્ટ",
