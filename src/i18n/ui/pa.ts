// explainer injected
export const uiTranslations_pa: Record<string, string> = {
  ...
  "brand.tagline": "ਤમારી આત્મા ਦੀ ਬਣਤਰ ਦਾ ਨਕਸ਼ਾ",
  ...
  "hero.title": "ਤੁਹਾਡਾ ਮੁਫ਼ਤ ਸੋਲ ਮੈਟ੍ਰਿਕਸ ਚਾਰਟ",
