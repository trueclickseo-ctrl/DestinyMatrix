// explainer injected
export const uiTranslations_nl: Record<string, string> = {
  ...
  "brand.tagline": "In kaart brengen van de architectuur van je ziel",
  ...
  "hero.title": "Jouw gratis Zielematrix kaart",
