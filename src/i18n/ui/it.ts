// explainer injected
export const uiTranslations_it: Record<string, string> = {
  ...
  "brand.tagline": "Mappatura dell’architettura della tua anima",
  ...
  "hero.title": "Il tuo grafico gratuito della Matrice del Destino",
