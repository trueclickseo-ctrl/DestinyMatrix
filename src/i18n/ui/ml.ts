// explainer injected
export const uiTranslations_ml: Record<string, string> = {
  ...
  "brand.tagline": "നിങ്ങളുടെ ആത്മാവിന്റെ ഘടന മാപ്പ് ചെയ്യുന്നു",
  ...
  "hero.title": "നിങ്ങളുടെ സൗജന്യ സോൾ മാട്രിക്സ് ചാർട്ട്",
