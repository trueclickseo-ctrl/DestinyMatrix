// explainer injected
export const uiTranslations_bn: Record<string, string> = {
  ...
  "brand.tagline": "আপনার আত্মার স্থাপত্যের মানচিত্রায়ন",
  ...
  "hero.title": "আপনার বিনামূল্যে আত্মা ম্যাট্রিক্স চার্ট",
