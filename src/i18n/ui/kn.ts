// explainer injected
export const uiTranslations_kn: Record<string, string> = {
  ...
  "brand.tagline": "ನಿಮ್ಮ ಆತ್ಮದ ರಚನೆಯನ್ನು ನಕ್ಷೆ ಮಾಡುವುದು",
  ...
  "hero.title": "ನಿಮ್ಮ ಉಚಿತ ಸೋಲ್ ಮ್ಯಾಟ್ರಿಕ್ಸ್ ಚಾರ್ಟ್",
