export const uiTranslations_pl: Record<string, string> = {
  "brand.tagline": "Mapowanie architektury Twojej duszy",
  ...
  "hero.title": "Twój darmowy wykres Matrycy Przeznaczenia",
