// explainer injected
export const uiTranslations_ur: Record<string, string> = {
  ...
  "brand.tagline": "اپنی روح کے فن تعمیر کا نقشہ بنانا",
  ...
  "hero.title": "آپ کا مفت ڈسٹنی میٹرکس چارٹ",
