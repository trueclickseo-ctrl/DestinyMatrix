// explainer injected
export const uiTranslations_te: Record<string, string> = {
  ...
  "brand.tagline": "మీ ఆత్మ యొక్క నిర్మాణాన్ని మ్యాపింగ్ చేయడం",
  ...
  "hero.title": "మీ ఉచిత ఆత్మ మ్యాట్రిక్స్ ఛార్ట్",
